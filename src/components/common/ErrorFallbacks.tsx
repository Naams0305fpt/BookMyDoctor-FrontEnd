    ...
    <div className="error-boundary">
      <div className="error-boundary-content">
        ...
        <p className="error-message">
          We're experiencing technical difficulties with the appointment booking system.
  ...
  return (
    <div className="error-boundary">
      <div className="error-boundary-content">
        ...
        <p className="error-message">
          We couldn't load your dashboard at this time.
    ...
    <div className="error-boundary">
      <div className="error-boundary-content">
        ...
        <p className="error-message">
          ...
          Your data is safe, but there was a technical issue.
        </p>
        <div className="error-actions">
          <button 
            className="btn-primary" 
